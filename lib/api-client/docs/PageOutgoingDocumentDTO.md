...
**content** | [**Array&lt;OutgoingDocumentDTO&gt;**](OutgoingDocumentDTO.md) |  | [optional] [default to undefined]
...
```typescript
import { PageOutgoingDocumentDTO } from './api';

const instance: PageOutgoingDocumentDTO = {
    totalElements,
    totalPages,
    pageable,
    first,
