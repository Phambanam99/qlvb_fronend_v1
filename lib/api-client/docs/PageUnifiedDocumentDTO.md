...
**content** | [**Array&lt;UnifiedDocumentDTO&gt;**](UnifiedDocumentDTO.md) |  | [optional] [default to undefined]
...
```typescript
import { PageUnifiedDocumentDTO } from './api';

const instance: PageUnifiedDocumentDTO = {
    totalElements,
    totalPages,
    pageable,
    first,
