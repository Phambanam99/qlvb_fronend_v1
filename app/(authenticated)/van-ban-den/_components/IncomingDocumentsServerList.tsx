...
} from "@/lib/actions/incoming-documents.actions";
import { IncomingDocumentsClient } from "./IncomingDocumentsClient";
import { Loader2 } from "lucide-react";

/**
 * Server Component for Incoming Documents List
...
interface IncomingDocumentsServerListProps {
...
export async function IncomingDocumentsServerList({
  searchParams = {},
}: IncomingDocumentsServerListProps) {
 ...
 */
export function IncomingDocumentsWithSuspense(
  props: IncomingDocumentsServerListProps
) {
  return (
    <Suspense fallback={<DocumentsListSkeleton />}>
      <IncomingDocumentsServerList {...props} />
    </Suspense>
  );
}
