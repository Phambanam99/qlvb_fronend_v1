  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">Quản lý và theo dõi các văn bản đi</p>
      </div>
      ...
      <Card className="border-primary/10 shadow-sm">
        <CardHeader className="bg-primary/5 border-b">
          ...
          <CardDescription>Danh sách các văn bản đi đã được tạo</CardDescription>
        </CardHeader>
              ...
              {filteredDocuments.length > 0 ? (
                filteredDocuments.map((doc) => (
                  <TableRow key={doc.id} className="hover:bg-accent/30">
                    ...
                    <TableCell className="hidden md:table-cell">{doc.sentDate}</TableCell>
                    <TableCell className="max-w-[300px] truncate">{doc.title}</TableCell>
                    <TableCell className="hidden md:table-cell">{doc.recipient}</TableCell>
